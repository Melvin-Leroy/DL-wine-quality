...
def load_data(file="~/Documents/BeCode/Projects/DL-wine-quality/data/wine.csv"):
...
class Net(nn.Module):
    def __init__(self, l1=120, l2=84):
        ...
        self.fc1 = nn.Linear(11, l1)
        self.fc2 = nn.Linear(l1, l2)
        self.fc3 = nn.Linear(l2, 7)
    ...
    def forward(self, x):
        ...
        x = F.relu(self.fc1(x))
        x = F.relu(self.fc2(x))
        x = last_layer_activation(self.fc3(x))
